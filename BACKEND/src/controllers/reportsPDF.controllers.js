    ...
    try {
        ...
        if (!compReData) {
            return res
                .status(404)
                .send(
                    "No se encontro la compañía reaseguradora con el ID proporcionado."
                );
        }
        ...
        doc.autoTable({
            head: [["Campo", "Valor"]],
            body: [
                ["Nombre Compannia Reaseguradora", compReData.nombre_compannia_reaseguradora],
    ...
    try {
        ...
        polizasData.forEach((poliza, index) => {
            ...
            doc.autoTable({
                ...
                head: [["Campo", "Valor"]],
                body: [
                    ["Numero de Póliza", poliza.numero_poliza],
